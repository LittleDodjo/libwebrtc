...
# Squeak: tvOS, visionOS и Mac Catalyst не собираем. Приложение под них не
# выходит, а это шесть отдельных прогонов ninja по всему движку — больше
# половины времени всей Apple-джобы.
